...
export const metadata: Metadata = {
  title: 'Fractional Recruitment Agency UK | Hire Fractional Executives',
  description: 'UK fractional recruitment agency specialising in CFO, CTO, CMO & COO placements. Transparent 10-15% fees, no retainers. Connect with vetted fractional executives.',
  keywords: 'fractional recruitment agency, fractional recruiters uk, fractional executive recruitment, hire fractional cfo, hire fractional cto, fractional cmo recruitment, fractional executive agency uk',
  alternates: {
    canonical: 'https://fractional.quest/fractional-recruitment-agency',
  },
  openGraph: {
    title: 'Fractional Recruitment Agency UK | Hire Fractional Executives',
    description: 'UK fractional recruitment agency specialising in CFO, CTO, CMO & COO placements. Transparent 10-15% fees, no retainers.',
    type: 'website',
      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            ...
            alt="Fractional recruitment agency UK - executive recruiters"
