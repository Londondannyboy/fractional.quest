...
export default async function FractionalJobsLondonPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Why London for Fractional Work - Comprehensive Content */}
      <section className="py-12 md:py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none text-gray-600">
            ...
            <h3 className="text-xl font-bold text-gray-900 mt-8 mb-4">Understanding London Day Rates</h3>
            <p className="mb-4">
            ...
            <p className="mb-4">
              Beyond role type, sector specialisation dramatically affects rates. A fractional CFO with deep fintech experience and FCA regulatory knowledge will command rates 20-30% higher than a generalist. Similarly, CTOs with AI/ML expertise or experience in highly regulated industries attract premium engagements. The <a href="https://www.cipd.org/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 underline">CIPD</a> notes that specialist skills in emerging technology areas can add £200-£400 to daily rates.
            </p>

            <h3 className="text-xl font-bold text-gray-900 mt-8 mb-4">Hybrid Working in London's Fractional Market</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-900 mt-8 mb-4">Building a Fractional Career in London</h3>
            ...
            <p>
              Several trends are shaping the future: larger organisations are increasingly adopting fractional models, not just startups and SMEs. The quality of fractional talent continues to rise as more senior executives—including former FTSE 100 leaders—enter the market. For companies and executives alike, London's fractional market offers compelling value: access to senior talent without full-time commitments, and flexible careers with premium earnings.
            </p>
          </div>
        </div>
      </section>
