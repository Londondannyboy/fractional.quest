...
export default function FractionalCFOServicesPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <WebPageSchema
        title="Fractional CFO Services UK"
        description="Hire a Fractional CFO for your business"
        url="https://fractional.quest/fractional-cfo-services"
        dateModified={new Date()}
      />
      <FAQPageSchema faqs={CFO_SERVICE_FAQS} />
      <ServiceSchema
        name="Fractional CFO Services"
        description="Hire a Fractional CFO for fundraising, financial strategy, and growth support"
        url="https://fractional.quest/fractional-cfo-services"
      ...
      <section className="relative min-h-[60vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Fractional CFO Services - Professional financial leadership"
            fill
            priority
            sizes="100vw"
        ...
        <div className="relative z-10 w-full py-20">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            <BreadcrumbsLight
              items={getRoleBreadcrumbs('cfo', 'services')}
              className="mb-8"
            />
