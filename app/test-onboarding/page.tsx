    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-6">
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="space-y-4">
          ...
          >
            <h2 className="text-xl font-bold text-gray-900 mb-2">Onboarding Router</h2>
            <p className="text-gray-600 text-sm">Choose between voice and manual</p>
          </Link>

          <div className="block w-full p-6 bg-gray-50/50 border-2 border-gray-600 rounded-xl opacity-50 cursor-not-allowed">
            <h2 className="text-xl font-bold text-gray-900 mb-2">Voice Onboarding (Requires Auth)</h2>
            <p className="text-gray-600 text-sm">Must be logged in - configure Stack Auth localhost first</p>
          </div>

          <div className="block w-full p-6 bg-gray-50/50 border-2 border-gray-600 rounded-xl opacity-50 cursor-not-allowed">
            <h2 className="text-xl font-bold text-gray-900 mb-2">Manual Onboarding (Requires Auth)</h2>
            <p className="text-gray-600 text-sm">Must be logged in - configure Stack Auth localhost first</p>
          </div>
        </div>
        ...
        <div className="mt-12 p-6 bg-yellow-900/20 border border-yellow-600/50 rounded-xl text-left">
          ...
          <ol className="text-gray-300 text-sm space-y-2">
            ...
            <li>3. Add: <code className="bg-gray-50/50 px-2 py-1 rounded">http://localhost:3000</code></li>
