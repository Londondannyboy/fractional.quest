...
export default function FractionalCISOServicesPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <WebPageSchema
        title="Fractional CISO Services UK"
        description="Hire a Fractional CISO for your business"
        url="https://fractional.quest/fractional-ciso-services"
      ...
      <ServiceSchema
        ...
        description="Hire a Fractional CISO for SOC 2, ISO 27001, security strategy, and compliance"
        url="https://fractional.quest/fractional-ciso-services"
        priceRange="£900-£1,600/day"
      />
      ...
      <section className="relative min-h-[75vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 w-full py-20">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            <BreadcrumbsLight items={getRoleBreadcrumbs('ciso', 'services')} className="mb-8" />
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <FAQ skipSchema={true} items={CISO_SERVICE_FAQS} title="" />
        </div>
      </section>
