...
// Get wider UK jobs (not Birmingham) for the "More Across UK" section
  ...
  try {
    ...
    const jobs = await sql`
      ...
      WHERE is_active = true
        ...
        AND location NOT ILIKE '%birmingham%'
      ORDER BY posted_date DESC NULLS LAST
      LIMIT 15
    `
    return jobs
...
export default async function BirminghamPage() {
  const [stats, jobs, widerUKJobs] = await Promise.all([getBirminghamStats(), getBirminghamJobs(), getWiderUKJobs()])
        ...
        <section className="py-6 bg-white border-b border-gray-100">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <HotJobsLines
              ...
              title="Latest Birmingham Fractional Jobs"
              maxJobs={12}
              viewAllHref="/fractional-jobs?location=Birmingham"
        ...
        <section className="py-12 bg-gray-50 border-t border-gray-200">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mb-6">
              ...
              <p className="text-gray-600">
                Remote and regional opportunities outside Birmingham. Many offer hybrid arrangements.
              </p>
            </div>
            <HotJobsLines
